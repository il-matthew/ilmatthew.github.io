...
function def1Support() {
	...
	document.getElementById("attack1support").className = "btn btn-outline-primary";
	document.getElementById("nonesupport").className = "btn btn-outline-primary";
	document.getElementById("def1support").className = "btn btn-outline-primary active";
	document.getElementById("def2support").className = "btn btn-outline-primary";
};
...
function noneSupport() {
	...
	document.getElementById("attack2support").className = "btn btn-outline-primary";
	document.getElementById("attack1support").className = "btn btn-outline-primary";
	document.getElementById("nonesupport").className = "btn btn-outline-primary active";
	document.getElementById("def1support").className = "btn btn-outline-primary";
	document.getElementById("def2support").className = "btn btn-outline-primary";
};
...
function att1Support() {
	...
	attackSupport1 = true;
	document.getElementById("attack2support").className = "btn btn-outline-primary";
	document.getElementById("attack1support").className = "btn btn-outline-primary active";
	document.getElementById("nonesupport").className = "btn btn-outline-primary";
	document.getElementById("def1support").className = "btn btn-outline-primary";
	document.getElementById("def2support").className = "btn btn-outline-primary";
};
...
function att2Support() {
	...
	attackSupport2 = true;
	attackSupport1 = true;
	document.getElementById("attack2support").className = "btn btn-outline-primary active";
	document.getElementById("attack1support").className = "btn btn-outline-primary";
	document.getElementById("nonesupport").className = "btn btn-outline-primary";
	document.getElementById("def1support").className = "btn btn-outline-primary";
	document.getElementById("def2support").className = "btn btn-outline-primary";
